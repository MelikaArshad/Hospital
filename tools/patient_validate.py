...
def father_name_validator(father_name):
...
def date_of_admission_validator(date_of_admission):
...
def attending_physician_validator(attending_physician):
...
def kind_of_ad_validator(kind_of_ad):
