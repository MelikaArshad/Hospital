...
class DepartmentView:
    ...
    def save_click(self):
        status, message = DepartmentController.save(self.department_name.get(),
    ...
    def edit_click(self):
        status, message = DepartmentController.update(self.department_id.get(), self.department_name.get(),
                                                      self.department_controller.get())
        if status:
    ...
    def reset_form(self):
        ...
        status, department = DepartmentController.find_all()
        if status:
          self.table.refresh_table(department)
        else:
            messagebox.showerror("Department Reset Error", department)
