...
-- Doctors
INSERT OR IGNORE INTO doctors (doctor_id, full_name, father_name, national_code, birth_date, personal_id_no, degree, phone_number, address, username, password) VALUES
...
-- Staffs
INSERT OR IGNORE INTO staffs (staff_id, full_name, father_name, national_code, personal_id_no, degree, birth_date, age, phone_number, address, username, password, ward, role) VALUES
...
-- Patients
INSERT OR IGNORE INTO patients (unit_no, full_name, father_name, national_code, birth_date, phone_number, height, weight, attending_physician,kind_of_ad, ward, room, bed) VALUES
...
INSERT OR IGNORE INTO medical_records (
    record_id, unit_no, full_name, staff_name, department_name, session_type,
